...
public class JarRunRequestBody extends JarRequestBody {
    ...
    private RecoveryClaimMode deprecatedRestoreMode;

    @JsonProperty(FIELD_NAME_SAVEPOINT_CLAIM_MODE)
    @Nullable
    private RecoveryClaimMode restoreMode;
    ...
    public JarRunRequestBody(
            ...
            @Nullable RecoveryClaimMode restoreMode,
    ...
    public JarRunRequestBody(
            ...
            RecoveryClaimMode deprecatedRestoreMode,
            @Nullable @JsonProperty(FIELD_NAME_SAVEPOINT_CLAIM_MODE) RecoveryClaimMode restoreMode,
