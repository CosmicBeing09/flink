...
public class KMeansData {
    ...
    public static DataSet<Centroid> getDefaultCentroidDataSet(BatchExecutionEnvironment env) {
    ...
    public static DataSet<Point> getDefaultPointDataSet(BatchExecutionEnvironment env) {
