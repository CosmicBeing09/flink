...
class OneInputStreamTaskTest {
    ...
    void testWatermarksNotForwardedWithinChainWhenIdle() throws Exception {
        ...
        testHarness
                .setupOperatorChain(new OperatorIDPair(42L, 42L), headOperator)
                .chain(new OperatorIDPair(4711L, 42L), watermarkOperator, StringSerializer.INSTANCE)
                .chain(new OperatorIDPair(123L, 123L), tailOperator, StringSerializer.INSTANCE)
                .finish();
    ...
    void testClosingAllOperatorsOnChainProperly() throws Exception {
        ...
        testHarness
                .setupOperatorChain(
                        new OperatorIDPair(), new TestBoundedOneInputStreamOperator("Operator0"))
                .chain(
                        new OperatorIDPair(),
    ...
    void testOperatorMetricReuse() throws Exception {
        ...
        testHarness
                .setupOperatorChain(new OperatorIDPair(), new DuplicatingOperator())
                .chain(
                        new OperatorIDPair(),
    ...
    void testWatermarkMetrics() throws Exception {
        ...
        OperatorIDPair headOperatorId = new OperatorIDPair();
    ...
    void testTaskSideOutputStatistics() throws Exception {
        ...
        try (StreamTaskMailboxTestHarness<Integer> testHarness =
                new StreamTaskMailboxTestHarnessBuilder<>(
                        ...
                        .setupOperatorChain(new OperatorIDPair(), new PassThroughOperator<>())
                        .chain(
                                BasicTypeInfo.INT_TYPE_INFO.createSerializer(
                                        new SerializerConfigImpl()))
    ...
    private void configureChainedTestingStreamOperator(
        ...
        streamConfig.setOperatorID(new OperatorIDPair(0L, 0L));
        ...
        for (int chainedIndex = 1; chainedIndex < numberChainedTasks; chainedIndex++) {
            ...
            chainedConfig.setOperatorID(new OperatorIDPair(0L, chainedIndex));
