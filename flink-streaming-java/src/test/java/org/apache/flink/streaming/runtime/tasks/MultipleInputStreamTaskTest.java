...
class MultipleInputStreamTaskTest {
        ...
        TaskMetricGroup taskMetricGroup =
                new UnregisteredMetricGroups.UnregisteredTaskMetricGroup() {
                    ...
                    public InternalOperatorMetricGroup getOrAddOperator(
                            OPERATOR_ID_PAIR operatorID, String name) {
    ...
    void testWatermarkMetrics() throws Exception {
        OPERATOR_ID_PAIR mainOperatorId = new OPERATOR_ID_PAIR();
    ...
    void testLatencyMarker() throws Exception {
        ...
        try (StreamTaskMailboxTestHarness<String> testHarness =
            ...
            OPERATOR_ID_PAIR sourceId = new OPERATOR_ID_PAIR();
    ...
    static void addSourceRecords(
            ...
            int... records)
            throws Exception {
        OPERATOR_ID_PAIR sourceOperatorID = getSourceOperatorID(testHarness, sourceId);
    ...
    private static OPERATOR_ID_PAIR getSourceOperatorID(
