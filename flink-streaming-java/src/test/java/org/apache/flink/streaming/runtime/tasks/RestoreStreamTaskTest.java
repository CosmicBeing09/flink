...
class RestoreStreamTaskTest {
    ...
    private static final Map<OPERATOR_ID_PAIR, Long> RESTORED_OPERATORS = new ConcurrentHashMap();
    ...
    void testRestore() throws Exception {
        ...
        OPERATOR_ID_PAIR headOperatorID = new OPERATOR_ID_PAIR(42L, 42L);
        OPERATOR_ID_PAIR tailOperatorID = new OPERATOR_ID_PAIR(44L, 44L);
    ...
    void testRestoreHeadWithNewId() throws Exception {
        ...
        createRunAndCheckpointOperatorChain(
                new OPERATOR_ID_PAIR(4242L, 4242L),
                new CounterOperator(),
                tailOperatorID,
                new CounterOperator(),
                Optional.of(restore));
    ...
    void testRestoreTailWithNewId() throws Exception {
        ...
        createRunAndCheckpointOperatorChain(
                headOperatorID,
                new CounterOperator(),
                new OPERATOR_ID_PAIR(4444L, 4444L),
                new CounterOperator(),
                Optional.of(restore));
