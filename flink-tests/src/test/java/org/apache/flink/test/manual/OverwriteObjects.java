...
public class OverwriteObjects {
    ...
    // DataStream values are randomly generated over this range
    ...
    public void testCross(ExecutionEnvironment env) throws Exception {
        ...
        DataStream<Tuple2<IntValue, IntValue>> small = getDataStream(env, 100, 20);
        DataStream<Tuple2<IntValue, IntValue>> large = getDataStream(env, 10000, 2000);
    ...
    private DataStream<Tuple2<IntValue, IntValue>> getDataStream(ExecutionEnvironment env) {
        return getDataStream(env, NUMBER_OF_ELEMENTS, KEY_RANGE);
    }

    private DataStream<Tuple2<IntValue, IntValue>> getFilteredDataStream(ExecutionEnvironment env) {
