...
public class UpdateJobResourceRequirementsITCase {
    ...
    private static Configuration createConfiguration() {
        ...
        configuration.set(WebOptions.WEB_UI_REFRESH_INTERVAL, Duration.ofMillis(50L));
        configuration.set(JobManagerOptions.JOB_MANAGER_SLOT_IDLE_TIMEOUT, Duration.ofMillis(50L));
