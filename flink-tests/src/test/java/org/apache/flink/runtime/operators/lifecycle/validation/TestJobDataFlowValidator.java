...
public class TestJobDataFlowValidator {
     ...
     * JobVertex#getOperatorIDPairs()}). If a chain doesn't contain any tracked operators return
     * nothing.
     */
    private static Optional<String> getTrackedOperatorID(
        ...
        ListIterator<OperatorIDPair> iterator =
                vertex.getOperatorIDPairs().listIterator(upstream ? 0 : vertex.getOperatorIDPairs().size());
