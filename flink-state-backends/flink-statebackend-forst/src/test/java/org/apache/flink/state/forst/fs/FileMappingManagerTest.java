...
public class FileMappingManagerTest {
    ...
    void testCreateFileBeforeRename() throws IOException {
        ...
        FileMappingManager.MappingEntry mappingEntry = fileMappingManager.createFile(new Path(create));
        FSDataOutputStream os1 = localFS.create(mappingEntry.path, FileSystem.WriteMode.OVERWRITE);
        os1.write(233);
        os1.close();
