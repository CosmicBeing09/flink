...
public class NestedIterationsTest extends CompilerTestBase {
    ...
    public void testRejectNestedBulkIterations() {
        try {
            ...
            DataStream<Long> data = env.generateSequence(1, 100);
    ...
    public void testRejectNestedWorksetIterations() {
        try {
            ...
            DataStream<Tuple2<Long, Long>> data = env.fromElements(new Tuple2<Long, Long>(0L, 0L));

            DeltaIteration<Tuple2<Long, Long>, Tuple2<Long, Long>> outerIteration =
                    data.iterateDelta(data, 100, 0);

            DataStream<Tuple2<Long, Long>> inOuter =
    ...
    public void testDeltaIterationInClosure() {
        try {
            ...
            DataStream<Tuple2<Long, Long>> data1 = env.fromElements(new Tuple2<Long, Long>(0L, 0L));
            DataStream<Tuple2<Long, Long>> data2 = env.fromElements(new Tuple2<Long, Long>(0L, 0L));

            DeltaIteration<Tuple2<Long, Long>, Tuple2<Long, Long>> firstIteration =
                    data1.iterateDelta(data1, 100, 0);

            DataStream<Tuple2<Long, Long>> inFirst =
            ...
            DataStream<Tuple2<Long, Long>> mainResult = mainIteration.closeWith(joined, joined);
