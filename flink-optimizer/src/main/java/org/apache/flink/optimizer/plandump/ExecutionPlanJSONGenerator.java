...
/**
 * Utility for extracting an execution plan (as JSON) from a given {@link StreamGraphPlan}.
 *
 * <p>We need this util here in the optimizer because it is the only module that has {@link
 * Optimizer}, {@link OptimizedStreamGraph}, and {@link StreamGraphJSONDumpGenerator} available. We use this
...
public class ExecutionPlanJSONGenerator implements ExecutionPlanUtil.ExecutionPlanJSONGenerator {
    ...
    @Override
    public String getExecutionPlan(StreamGraphPlan plan) {
        Optimizer opt =
                new Optimizer(
