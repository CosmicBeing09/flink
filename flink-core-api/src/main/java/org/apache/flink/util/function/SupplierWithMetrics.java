...
/**
 * A functional interface for a {@link java.util.function.Supplier} that supplies metrics and may throw exceptions.
 *
...
@Public
@FunctionalInterface
public interface SupplierWithMetrics<R, E extends Throwable> {
