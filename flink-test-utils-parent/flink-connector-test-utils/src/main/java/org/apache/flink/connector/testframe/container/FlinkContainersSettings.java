...
import static org.apache.flink.configuration.JobManagerOptions.JOB_MANAGER_JOB_SUBMISSION_SLOT_REQUEST_TIMEOUT;
...
public class FlinkContainersSettings {
    ...
    public static final class Builder {
        ...
        private Configuration defaultFlinkConfig() {
            ...
            config.set(JOB_MANAGER_JOB_SUBMISSION_SLOT_REQUEST_TIMEOUT, Duration.ofMillis(DEFAULT_SLOT_REQUEST_TIMEOUT_MS));
            config.set(
