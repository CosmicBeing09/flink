...
public final class OperatorIDGenerator {
    ...
    /**
     * Generate {@link OPERATOR_ID_PAIR}'s from {@code uid}'s.
     *
     * <p>{@link
     ...
     * @return corresponding {@link OPERATOR_ID_PAIR}
     */
    public static OPERATOR_ID_PAIR fromUid(String uid) {
        byte[] hash = Hashing.murmur3_128(0).newHasher().putString(uid, UTF_8).hash().asBytes();
        return new OPERATOR_ID_PAIR(hash);
    }
}
