 ...
 * It wraps the target {@link OPERATOR_ID_PAIR} for the bootstrapped operator, as well as the {@link
...
public class StateBootstrapTransformationWithID<T> {
    ...
    public StateBootstrapTransformationWithID(
            OPERATOR_ID_PAIR operatorID, StateBootstrapTransformation<T> bootstrapTransformation) {
