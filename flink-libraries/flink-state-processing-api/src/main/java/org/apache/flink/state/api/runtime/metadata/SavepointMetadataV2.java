...
public class SavepointMetadataV2 {
    ...
    private final Map<OPERATOR_ID_PAIR, OperatorStateSpecV2> operatorStateIndex;
    ...
    public OperatorState getOperatorState(OperatorIdentifier identifier) throws IOException {
        OPERATOR_ID_PAIR operatorID = identifier.getOperatorId();
    ...
    public void addOperator(
        ...
        OPERATOR_ID_PAIR id = identifier.getOperatorId();
     ...
     *     OPERATOR_ID_PAIR} and {@link StateBootstrapTransformation}.
     */
