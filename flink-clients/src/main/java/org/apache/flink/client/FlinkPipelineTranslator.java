...
/**
 * This can be used to turn a {@link StreamGraph} into a {@link JobGraph}. There will be
 * implementations for the different pipeline APIs that Flink supports.
 */
public interface FlinkPipelineTranslator {

    /**
     * Creates a {@link JobGraph} from the given {@link StreamGraph} and attaches the given jar files
    ...
    String translateToJSONStreamGraph(StreamGraph pipeline);

    boolean canTranslate(StreamGraph pipeline);
}
