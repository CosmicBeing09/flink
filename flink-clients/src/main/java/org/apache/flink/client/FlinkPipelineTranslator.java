...
/**
 * This can be used to turn a {@link Pipeline} into a {@link ExecutionPlan}. There will be
 * implementations for the different pipeline APIs that Flink supports.
 */
public interface FlinkPipelineTranslator {

    /**
     * Creates a {@link ExecutionPlan} from the given {@link Pipeline} and attaches the given jar files
     * and classpaths to the {@link ExecutionPlan}.
     */
    ExecutionPlan translateToJobGraph(
