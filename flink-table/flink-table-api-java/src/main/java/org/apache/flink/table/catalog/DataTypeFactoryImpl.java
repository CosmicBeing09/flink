...
final class DataTypeFactoryImpl implements DataTypeFactory {
    ...
    private final LogicalTypeResolver unresolvedTypeResolver = new LogicalTypeResolver();
    ...
    public LogicalType createLogicalType(String typeString) {
        final LogicalType parsedLogicalType = LogicalTypeParser.parse(typeString, userClassLoader);
        return parsedLogicalType.accept(unresolvedTypeResolver);
    }
