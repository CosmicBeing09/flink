...
final class CalculatedTableFactory {
    ...
    /**
     * Creates a valid {@link CorrelatedFunctionTableFactory} operation.
     *
    ...
    private static class FunctionTableCallVisitor
            extends ResolvedExpressionDefaultVisitor<CorrelatedFunctionTableFactory> {
        ...
        @Override
        public CorrelatedFunctionTableFactory visit(CallExpression call) {
        ...
        private CorrelatedFunctionTableFactory unwrapFromAlias(CallExpression call) {
        ...
        private CorrelatedFunctionTableFactory createFunctionCall(
            ...
            return new CorrelatedFunctionTableFactory(
        ...
        @Override
        protected CorrelatedFunctionTableFactory defaultMethod(ResolvedExpression expression) {
            throw fail();
        }
