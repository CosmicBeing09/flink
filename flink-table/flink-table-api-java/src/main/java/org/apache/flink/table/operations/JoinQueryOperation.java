...
public class JoinQueryOperation implements QueryOperation {
    ...
    public String asSerializableString() {
        ...
        inputAliases.put(1, correlated ? CorrelatedFunctionTableFactory.INPUT_ALIAS : INPUT_2_ALIAS);
    ...
    private String getSelectList() {
        ...
        String rightColumns =
                OperationUtils.formatSelectColumns(
                        ...
                        correlated ? CorrelatedFunctionTableFactory.INPUT_ALIAS : INPUT_2_ALIAS);
