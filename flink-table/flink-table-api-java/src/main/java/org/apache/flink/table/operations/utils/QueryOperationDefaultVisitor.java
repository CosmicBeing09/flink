...
public abstract class QueryOperationDefaultVisitor<T> implements QueryOperationVisitor<T> {
    ...
    @Override
    public T visit(ProjectQueryOperation projectOperation) {
        return defaultMethod(projectOperation);
    }
    ...
    @Override
    public T visit(LateralTableQueryOperation lateralOperation) {
        return defaultMethod(lateralOperation);
    }
