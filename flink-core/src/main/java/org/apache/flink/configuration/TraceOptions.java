...
public class TraceOptions {
    ...
    private static final String NAMED_TRACE_REPORTER_CONFIG_PREFIX =
     ...
     * }</pre>
     */
    public static final ConfigOption<String> TRACES_REPORTER_NAME_LIST =
    ...
    @Documentation.SuffixOption(NAMED_TRACE_REPORTER_CONFIG_PREFIX)
