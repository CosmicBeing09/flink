...
public class ResourceManagerOptions {
     ...
     * by registered slots. If not set, {@link JobManagerOptions#JOB_MANAGER_JOB_SUBMISSION_SLOT_REQUEST_TIMEOUT} will be used
     * by default.
     */
                    ...
                    .withDescription(
                            Description.builder()
                                    .text(
                                            ...
                                            TextElement.code(
                                                    JobManagerOptions.JOB_MANAGER_JOB_SUBMISSION_SLOT_REQUEST_TIMEOUT.key()))
                                    .build());
