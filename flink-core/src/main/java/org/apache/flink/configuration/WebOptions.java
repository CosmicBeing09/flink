...
public class WebOptions {
    ...
    public static final ConfigOption<Duration> webFrontendRefreshInterval =
    ...
    public static final ConfigOption<String> webRestApiTempDir =
            key("web.tmpdir")
                    .stringType()
