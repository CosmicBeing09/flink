...
public class WebOptions {
    ...
    public static final ConfigOption<Duration> WEB_REFRESH_INTERVAL_MS =
    ...
    public static final ConfigOption<String> WEB_TEMP_DIRECTORY =
            key("web.tmpdir")
                    .stringType()
