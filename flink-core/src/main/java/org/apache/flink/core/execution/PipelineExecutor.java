...
/** The entity responsible for executing a {@link StreamGraph}, i.e. a user job. */
@Internal
public interface PipelineExecutor {

    /**
     * Executes a {@link StreamGraph} based on the provided configuration and returns a {@link
     ...
     * call-site.
     *
     * @param pipeline the {@link StreamGraph} to execute
