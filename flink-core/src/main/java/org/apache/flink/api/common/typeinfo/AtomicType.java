...
public interface AtomicType<T> {
     ...
     * @param config The config from which the comparator will be parametrized.
     ...
     */
    TypeComparator<T> createComparator(boolean sortOrderAscending, ExecutionConfig config);
}
