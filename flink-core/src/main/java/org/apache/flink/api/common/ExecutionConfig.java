...
public class ExecutionConfig implements Serializable, Archiveable<ArchivedExecutionConfig> {
    ...
    public ExecutionConfig setClosureCleanerLevel(ClosureCleanerLevel level) {
        configuration.set(StreamingPipelineOptions.CLOSURE_CLEANER_LEVEL, level);
        return this;
    }

    /** Returns the configured {@link ClosureCleanerLevel}. */
    public ClosureCleanerLevel getClosureCleanerLevel() {
        return configuration.get(StreamingPipelineOptions.CLOSURE_CLEANER_LEVEL);
    }
    ...
    private ExecutionConfig setAutoWatermarkInterval(Duration autoWatermarkInterval) {
        configuration.set(StreamingPipelineOptions.AUTO_WATERMARK_INTERVAL, autoWatermarkInterval);
        return this;
    }
    ...
    public long getAutoWatermarkInterval() {
        return configuration.get(StreamingPipelineOptions.AUTO_WATERMARK_INTERVAL).toMillis();
    }
    ...
    public int getMaxParallelism() {
        return configuration.get(StreamingPipelineOptions.MAX_PARALLELISM);
    }
    ...
    public void setMaxParallelism(int maxParallelism) {
        ...
        configuration.set(StreamingPipelineOptions.MAX_PARALLELISM, maxParallelism);
    }
    ...
    private void setAutoGeneratedUids(boolean autoGeneratedUids) {
        configuration.set(StreamingPipelineOptions.AUTO_GENERATE_UIDS, autoGeneratedUids);
    }
    ...
    public boolean hasAutoGeneratedUIDsEnabled() {
        return configuration.get(StreamingPipelineOptions.AUTO_GENERATE_UIDS);
    }
    ...
    private ExecutionConfig setObjectReuse(boolean objectReuse) {
        configuration.set(StreamingPipelineOptions.OBJECT_REUSE, objectReuse);
        return this;
    }

    /** Returns whether object reuse has been enabled or disabled. @see #enableObjectReuse() */
    public boolean isObjectReuseEnabled() {
        return configuration.get(StreamingPipelineOptions.OBJECT_REUSE);
    }
    ...
    private void setGlobalJobParameters(Map<String, String> parameters) {
        configuration.set(StreamingPipelineOptions.GLOBAL_JOB_PARAMETERS, parameters);
    }
     ...
     * StreamingPipelineOptions#CLOSURE_CLEANER_LEVEL}.
     *
    ...
    public void configure(ReadableConfig configuration, ClassLoader classLoader) {
        configuration
                .getOptional(StreamingPipelineOptions.AUTO_GENERATE_UIDS)
                .ifPresent(this::setAutoGeneratedUids);
        configuration
                .getOptional(StreamingPipelineOptions.AUTO_WATERMARK_INTERVAL)
                .ifPresent(this::setAutoWatermarkInterval);
        configuration
                .getOptional(StreamingPipelineOptions.CLOSURE_CLEANER_LEVEL)
        ...
        configuration
                .getOptional(StreamingPipelineOptions.MAX_PARALLELISM)
                .ifPresent(this::setMaxParallelism);
        configuration.getOptional(CoreOptions.DEFAULT_PARALLELISM).ifPresent(this::setParallelism);
        configuration.getOptional(StreamingPipelineOptions.OBJECT_REUSE).ifPresent(this::setObjectReuse);
        configuration
