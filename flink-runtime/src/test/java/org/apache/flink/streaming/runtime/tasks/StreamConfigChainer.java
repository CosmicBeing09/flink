...
public class StreamConfigChainer<OWNER> {
    ...
    StreamConfigChainer(
            OPERATOR_ID_PAIR headOperatorID,
    ...
    private void head(OPERATOR_ID_PAIR headOperatorID) {
    ...
    public <T> StreamConfigChainer<OWNER> chain(
        ...
        return chain(new OPERATOR_ID_PAIR(), operator, typeSerializer);
    }
    ...
    public <T> StreamConfigChainer<OWNER> chain(
        ...
        return chain(new OPERATOR_ID_PAIR(), operatorFactory, typeSerializer);
    }
    ...
    public static class StreamConfigEdgeChainer<OWNER, IN, OUT> {
        ...
        public StreamConfigEdgeChainer<OWNER, IN, OUT> setOperatorID(OPERATOR_ID_PAIR operatorID) {
        ...
        public StreamConfigChainer<OWNER> build() {
            ...
            parent.tailConfig.setOperatorID(operatorID == null ? new OPERATOR_ID_PAIR() : operatorID);
