...
public class AbstractStreamOperatorTestHarness<OUT> implements AutoCloseable {
    ...
    public AbstractStreamOperatorTestHarness(
            ...
            throws Exception {
        this(operator, maxParallelism, parallelism, subtaskIndex, new OperatorIDPair());
    }
    ...
    public AbstractStreamOperatorTestHarness(
        ...
        this(null, factory, env, false, new OperatorIDPair());
    }
    ...
    public AbstractStreamOperatorTestHarness(StreamOperator<OUT> operator, MockEnvironment env)
            throws Exception {
        this(operator, SimpleOperatorFactory.of(operator), env, false, new OperatorIDPair());
    }

    public AbstractStreamOperatorTestHarness(
            StreamOperator<OUT> operator, String taskName, OperatorIDPair operatorID) throws Exception {
        this(
                operator,
                SimpleOperatorFactory.of(operator),
                new MockEnvironmentBuilder()
