...
public class AdaptiveSchedulerBuilder {
    private static final Duration SUBMISSION_RESOURCE_STABILIZATION_TIMEOUT = Duration.ofSeconds(300);
    ...
    private Duration submissionResourceStabilizationTimeout = SUBMISSION_RESOURCE_STABILIZATION_TIMEOUT;
    ...
    public AdaptiveSchedulerBuilder setRpcTimeout(final Duration rpcTimeout) {
        this.submissionResourceStabilizationTimeout = rpcTimeout;
        return this;
    }
