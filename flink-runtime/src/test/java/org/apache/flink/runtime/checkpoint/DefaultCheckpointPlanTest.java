...
class DefaultCheckpointPlanTest {
    ...
    void testFulfillFinishedStates() throws Exception {
        ...
        OPERATOR_ID_PAIR fullyFinishedOperatorId = new OPERATOR_ID_PAIR();
        OPERATOR_ID_PAIR finishedOnRestoreOperatorId = new OPERATOR_ID_PAIR();
        OPERATOR_ID_PAIR partiallyFinishedOperatorId = new OPERATOR_ID_PAIR();
    ...
    void testFulfillFullyFinishedStatesWithCoordinator() throws Exception {
        ...
        OPERATOR_ID_PAIR finishedOperatorID = new OPERATOR_ID_PAIR();
