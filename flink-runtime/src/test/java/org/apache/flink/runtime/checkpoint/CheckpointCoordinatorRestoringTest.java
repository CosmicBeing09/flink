...
class CheckpointCoordinatorRestoringTest {
    ...
    private void testRestoreLatestCheckpointedStateWithChangingParallelism(boolean scaleOut)
        ...
        for (int index = 0; index < jobVertex1.getParallelism(); index++) {
            ...
            taskOperatorSubtaskStates.putSubtaskStateByOperatorID(
                    OperatorIDPair.fromJobVertexID(jobVertexID1), operatorSubtaskState);
        ...
        for (int index = 0; index < jobVertex2.getParallelism(); index++) {
            ...
            TaskStateSnapshot taskOperatorSubtaskStates = new TaskStateSnapshot();
            taskOperatorSubtaskStates.putSubtaskStateByOperatorID(
                    OperatorIDPair.fromJobVertexID(jobVertexID2), operatorSubtaskState);
        ...
        for (int i = 0; i < newJobVertex2.getParallelism(); i++) {
            ...
            List<org.apache.flink.runtime.OperatorIDPair> operatorIDs = newJobVertex2.getOperatorIDs();
            ...
            for (int idx = 0; idx < operatorIDs.size(); ++idx) {
                OperatorIDPair operatorID = operatorIDs.get(idx).getGeneratedOperatorID();
    ...
    private static Tuple2<JobVertexID, OperatorIDPair> generateIDPair() {
        JobVertexID jobVertexID = new JobVertexID();
        OperatorIDPair operatorID = OperatorIDPair.fromJobVertexID(jobVertexID);
    ...
    public void testStateRecoveryWithTopologyChange(TestScaleType scaleType) throws Exception {
         ...
         */
        Tuple2<JobVertexID, OperatorIDPair> id1 = generateIDPair();
        Tuple2<JobVertexID, OperatorIDPair> id2 = generateIDPair();
        int parallelism1 = 10;
        int maxParallelism1 = 64;

        Tuple2<JobVertexID, OperatorIDPair> id3 = generateIDPair();
        Tuple2<JobVertexID, OperatorIDPair> id4 = generateIDPair();
        int parallelism2 = 10;
        ...
        for (Tuple2<JobVertexID, OperatorIDPair> id : Arrays.asList(id1, id2)) {
        ...
        for (Tuple2<JobVertexID, OperatorIDPair> id : Arrays.asList(id3, id4)) {
         ...
         */
        Tuple2<JobVertexID, OperatorIDPair> id5 = generateIDPair();
        int newParallelism1 = 10;

        Tuple2<JobVertexID, OperatorIDPair> id6 = generateIDPair();
        ...
        for (int i = 0; i < newJobVertex1.getParallelism(); i++) {
            ...
            final List<org.apache.flink.runtime.OperatorIDPair> operatorIDs = newJobVertex1.getOperatorIDs();
        ...
        for (int i = 0; i < newJobVertex2.getParallelism(); i++) {
            ...
            final List<org.apache.flink.runtime.OperatorIDPair> operatorIDs = newJobVertex2.getOperatorIDs();
    ...
    void testRestoreLatestCheckpointedStateWithoutInFlightData() throws Exception {
        ...
        for (int index = 0; index < jobVertex.getParallelism(); index++) {
            ...
            TaskStateSnapshot taskOperatorSubtaskStates = new TaskStateSnapshot();
            taskOperatorSubtaskStates.putSubtaskStateByOperatorID(
                    OperatorIDPair.fromJobVertexID(jobVertexID), operatorSubtaskState);
        ...
        for (int i = 0; i < jobVertex.getParallelism(); i++) {
            ...
            OperatorSubtaskState operatorState =
                    stateSnapshot.getSubtaskStateByOperatorID(
                            OperatorIDPair.fromJobVertexID(jobVertexID));
