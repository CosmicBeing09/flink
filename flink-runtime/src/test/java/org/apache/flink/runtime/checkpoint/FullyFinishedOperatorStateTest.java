...
class FullyFinishedOperatorStateTest {
    ...
    void testFullyFinishedOperatorState() {
        OperatorState operatorState = new FullyFinishedOperatorState(new OperatorIDPair(), 5, 256);
    ...
    void testGetDiscardables() throws IOException {
        ...
        OperatorState operatorState = new OperatorState(new OperatorIDPair(), 2, 256);
