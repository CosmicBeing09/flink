...
class DefaultMetricFilterTest {
    ...
    void testConvertToPatternWithoutWildcards() {
        final Pattern pattern = DefaultReporterFilter.convertToPattern("numRecordsIn");
    ...
    void testConvertToPatternSingle() {
        final Pattern pattern = DefaultReporterFilter.convertToPattern("numRecords*");
    ...
    void testConvertToPatternMultiple() {
        final Pattern pattern = DefaultReporterFilter.convertToPattern("numRecords*,numBytes*");
    ...
    void testParseMetricTypesSingle() {
        final EnumSet<MetricType> types = DefaultReporterFilter.parseMetricTypes("meter");
        assertThat(types).containsExactly(MetricType.METER);
    }

    @Test
    void testParseMetricTypesMultiple() {
        final EnumSet<MetricType> types = DefaultReporterFilter.parseMetricTypes("meter,counter");
    ...
    void testFromConfigurationIncludeByScope() {
        ...
        final ReporterFilter metricFilter = DefaultReporterFilter.fromConfiguration(configuration);
