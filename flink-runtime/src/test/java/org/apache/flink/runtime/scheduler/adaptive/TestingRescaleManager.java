...
public class TestingRescaleManager implements TransitionToSubsequentStateManager {
    ...
    public static class Factory implements TransitionToSubsequentStateManager.Factory {
        ...
        @Override
        public TransitionToSubsequentStateManager create(Context ignoredContext, Instant ignoredLastRescale) {
