...
class CheckpointCoordinatorTest {
    ...
    void testTriggerAndConfirmSimpleCheckpoint() throws Exception {
        ...
        OPERATOR_ID_PAIR opID1 = vertex1.getJobVertex().getOperatorIDPairs().get(0).getGeneratedOperatorID();
        OPERATOR_ID_PAIR opID2 = vertex2.getJobVertex().getOperatorIDPairs().get(0).getGeneratedOperatorID();
    ...
    void testSuccessfulCheckpointSubsumesUnsuccessful() throws Exception {
        ...
        OPERATOR_ID_PAIR opID1 = vertex1.getJobVertex().getOperatorIDPairs().get(0).getGeneratedOperatorID();
        OPERATOR_ID_PAIR opID2 = vertex2.getJobVertex().getOperatorIDPairs().get(0).getGeneratedOperatorID();
        OPERATOR_ID_PAIR opID3 = vertex3.getJobVertex().getOperatorIDPairs().get(0).getGeneratedOperatorID();
    ...
    void testStateCleanupForLateOrUnknownMessages() throws Exception {
        ...
        OPERATOR_ID_PAIR opIDtrigger =
                vertex1.getJobVertex().getOperatorIDPairs().get(0).getGeneratedOperatorID();
    ...
    void testTriggerAndConfirmSimpleSavepoint() throws Exception {
        ...
        OPERATOR_ID_PAIR opID1 = OPERATOR_ID_PAIR.fromJobVertexID(vertex1.getJobvertexId());
        OPERATOR_ID_PAIR opID2 = OPERATOR_ID_PAIR.fromJobVertexID(vertex2.getJobvertexId());
        OperatorSubtaskState subtaskState1 = mock(OperatorSubtaskState.class);
        OperatorSubtaskState subtaskState2 = mock(OperatorSubtaskState.class);
        TaskStateSnapshot taskOperatorSubtaskStates1 =
                new TaskStateSnapshot(singletonMap(opID1, subtaskState1));
    ...
    void testCheckpointStatsTrackerRestoreCallback() throws Exception {
        ...
        store.addCheckpointAndSubsumeOldestOne(
                new CompletedCheckpoint(
                        ...
                        0,
                        0,
                        Collections.<OPERATOR_ID_PAIR, OperatorState>emptyMap(),
    ...
    private void performIncrementalCheckpoint(
        ...
        for (int index = 0; index < jobVertex1.getParallelism(); index++) {
            ...
            Map<OPERATOR_ID_PAIR, OperatorSubtaskState> opStates = new HashMap<>();

            opStates.put(
                    jobVertex1.getOperatorIDPairs().get(0).getGeneratedOperatorID(),
    ...
    private void ackCheckpoint(
        ...
        OPERATOR_ID_PAIR operatorID = jobVertex.getOperatorIDPairs().get(0).getGeneratedOperatorID();
        coordinator.receiveAcknowledgeMessage(
                new AcknowledgeCheckpoint(
                        graph.getJobID(),
