...
class CheckpointCoordinatorTest {
    ...
    void testTriggerAndConfirmSimpleCheckpoint() throws Exception {
        ...
        OperatorID opID1 = vertex1.getJobVertex().getOperatorIDPairs().get(0).getGeneratedOperatorID();
        OperatorID opID2 = vertex2.getJobVertex().getOperatorIDPairs().get(0).getGeneratedOperatorID();
    ...
    void testSuccessfulCheckpointSubsumesUnsuccessful() throws Exception {
        ...
        OperatorID opID1 = vertex1.getJobVertex().getOperatorIDPairs().get(0).getGeneratedOperatorID();
        OperatorID opID2 = vertex2.getJobVertex().getOperatorIDPairs().get(0).getGeneratedOperatorID();
        OperatorID opID3 = vertex3.getJobVertex().getOperatorIDPairs().get(0).getGeneratedOperatorID();
    ...
    private void ackCheckpoint(
        ...
        OperatorID operatorID = jobVertex.getOperatorIDPairs().get(0).getGeneratedOperatorID();
        coordinator.receiveAcknowledgeMessage(
                new AcknowledgeCheckpoint(
                        graph.getJobID(),
