...
class CheckpointCoordinatorTest {
    ...
    void testTriggerAndConfirmSimpleCheckpoint() throws Exception {
        ...
        OperatorIDPair opID1 = vertex1.getJobVertex().getOperatorIDs().get(0).getGeneratedOperatorID();
        OperatorIDPair opID2 = vertex2.getJobVertex().getOperatorIDs().get(0).getGeneratedOperatorID();
    ...
    void testSuccessfulCheckpointSubsumesUnsuccessful() throws Exception {
        ...
        OperatorIDPair opID1 = vertex1.getJobVertex().getOperatorIDs().get(0).getGeneratedOperatorID();
        OperatorIDPair opID2 = vertex2.getJobVertex().getOperatorIDs().get(0).getGeneratedOperatorID();
        OperatorIDPair opID3 = vertex3.getJobVertex().getOperatorIDs().get(0).getGeneratedOperatorID();
    ...
    private void ackCheckpoint(
        ...
        OperatorIDPair operatorID = jobVertex.getOperatorIDs().get(0).getGeneratedOperatorID();
        coordinator.receiveAcknowledgeMessage(
                new AcknowledgeCheckpoint(
                        graph.getJobID(),
