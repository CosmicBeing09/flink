...
class CheckpointCoordinatorTest {
    ...
    void testTriggerAndConfirmSimpleCheckpoint() throws Exception {
        ...
        OperatorID opID1 = vertex1.getJobVertex().getOperatorIdentifier().get(0).getGeneratedOperatorID();
        OperatorID opID2 = vertex2.getJobVertex().getOperatorIdentifier().get(0).getGeneratedOperatorID();
    ...
    void testSuccessfulCheckpointSubsumesUnsuccessful() throws Exception {
        ...
        OperatorID opID1 = vertex1.getJobVertex().getOperatorIdentifier().get(0).getGeneratedOperatorID();
        OperatorID opID2 = vertex2.getJobVertex().getOperatorIdentifier().get(0).getGeneratedOperatorID();
        OperatorID opID3 = vertex3.getJobVertex().getOperatorIdentifier().get(0).getGeneratedOperatorID();
    ...
    void testStateCleanupForLateOrUnknownMessages() throws Exception {
        ...
        OperatorID opIDtrigger =
                vertex1.getJobVertex().getOperatorIdentifier().get(0).getGeneratedOperatorID();
    ...
    private void performIncrementalCheckpoint(
        ...
        for (int index = 0; index < jobVertex1.getParallelism(); index++) {
            ...
            opStates.put(
                    jobVertex1.getOperatorIdentifier().get(0).getGeneratedOperatorID(),
    ...
    private void ackCheckpoint(
        ...
        OperatorID operatorID = jobVertex.getOperatorIdentifier().get(0).getGeneratedOperatorID();
        coordinator.receiveAcknowledgeMessage(
                new AcknowledgeCheckpoint(
                        graph.getJobID(),
