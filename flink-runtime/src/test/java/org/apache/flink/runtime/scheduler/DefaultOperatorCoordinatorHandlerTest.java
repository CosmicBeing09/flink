...
class DefaultOperatorCoordinatorHandlerTest {
    ...
    void testRegisterAndStartNewCoordinators() throws Exception {
        ...
        OperatorIDPair operatorId1 = OperatorIDPair.fromJobVertexID(jobVertices[0].getID());
        OperatorIDPair operatorId2 = OperatorIDPair.fromJobVertexID(jobVertices[1].getID());
        ...
        jobVertices[0].addOperatorCoordinator(
                new SerializedValue<>(
                        new TestingOperatorCoordinator.Provider(
                                OperatorIDPair.fromJobVertexID(jobVertices[0].getID()))));

        jobVertices[1].addOperatorCoordinator(
                new SerializedValue<>(
                        new TestingOperatorCoordinator.Provider(
                                OperatorIDPair.fromJobVertexID(jobVertices[1].getID()))));
