...
class CheckpointStateRestoreTest {
    ...
    void testSetState() {
        try {
            ...
            subtaskStates.putSubtaskStateByOperatorID(
                    OPERATOR_ID_PAIR.fromJobVertexID(statefulId),
    ...
    void testNonRestoredState() throws Exception {
        ...
        OPERATOR_ID_PAIR operatorId1 = OPERATOR_ID_PAIR.fromJobVertexID(jobVertexId1);
        ...
        Map<OPERATOR_ID_PAIR, OperatorState> checkpointTaskStates = new HashMap<>();
        {
        ...
        OPERATOR_ID_PAIR newOperatorID = OPERATOR_ID_PAIR.fromJobVertexID(newJobVertexID);
                ...
                .thenReturn(
                        Collections.singletonList(
                                org.apache.flink.runtime.OperatorIDPair.generatedIDOnly(
                                        OPERATOR_ID_PAIR.fromJobVertexID(id))));
