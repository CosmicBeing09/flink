...
public class RestHandlerConfiguration {
    ...
    public static RestHandlerConfiguration fromConfiguration(Configuration configuration) {
        final long refreshInterval = configuration.get(WebOptions.WEB_REFRESH_INTERVAL_MS).toMillis();
        ...
        final File webUiDir = new File(configuration.get(WebOptions.WEB_TEMP_DIRECTORY), rootDir);
