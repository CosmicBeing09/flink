...
class Executing extends StateWithExecutionGraph
        implements ResourceListener, TransitionToSubsequentStateManager.Context, CheckpointStatsListener {
    ...
    private final TransitionToSubsequentStateManager transitionToSubsequentStateManager;
    ...
    Executing(
        ...
        this.transitionToSubsequentStateManager = rescaleManagerFactory.create(this, lastRescale);
    ...
    static class Factory implements StateFactory<Executing> {
        ...
        private final TransitionToSubsequentStateManager.Factory transitionToSubsequentStateManagerFactory;
