...
public interface TaskStateManager extends CheckpointListener, AutoCloseable {
     ...
     */
    @Nonnull
    PrioritizedOperatorSubtaskState prioritizedOperatorState(OPERATOR_ID_PAIR operatorID);
     ...
     */
    Optional<OperatorSubtaskState> getSubtaskJobManagerRestoredState(OPERATOR_ID_PAIR operatorID);
