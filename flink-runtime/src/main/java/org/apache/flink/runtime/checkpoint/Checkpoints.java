...
public class Checkpoints {
    ...
    public static CompletedCheckpoint loadAndValidateCheckpoint(
        ...
        Map<OperatorIDPair, ExecutionJobVertex> operatorToJobVertexMapping = new HashMap<>();
        for (ExecutionJobVertex task : tasks.values()) {
            for (org.apache.flink.runtime.OperatorIDPair operatorIDPair : task.getOperatorIDs()) {
        ...
        HashMap<OperatorIDPair, OperatorState> operatorStates =
    ...
    private static void throwNonRestoredStateException(
            String checkpointPointer, OperatorIDPair operatorId) {
        String msg =
                String.format(
                        "Failed to rollback to checkpoint/savepoint %s. "
