...
public class OperatorState implements CompositeStateHandle {
    ...
    private final OPERATOR_ID_PAIR operatorIDPair;
    ...
    public OperatorState(OPERATOR_ID_PAIR operatorIDPair, int parallelism, int maxParallelism) {
    ...
    public OperatorState copyWithNewOperatorID(OPERATOR_ID_PAIR newOperatorId) {
