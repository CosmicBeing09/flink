...
/** The {@code AdaptiveScalingManager} decides on whether rescaling should happen or not. */
public interface AdaptiveScalingManager {
    ...
    interface Factory {
         ...
         */
        AdaptiveScalingManager create(Context rescaleContext, Instant lastRescale);
    }
}
