...
public class ExecutionVertexFinishedEvent implements JobEvent {
    ...
    private transient Map<OperatorIDPair, CompletableFuture<byte[]>> operatorCoordinatorSnapshotFutures;
    ...
    public ExecutionVertexFinishedEvent(
            ...
            Map<OperatorIDPair, CompletableFuture<byte[]>> operatorCoordinatorSnapshotFutures,
    ...
    public Map<OperatorIDPair, CompletableFuture<byte[]>> getOperatorCoordinatorSnapshotFutures() {
    ...
    static class Serializer implements SimpleVersionedSerializer<JobEvent> {
        ...
        public JobEvent deserialize(int version, byte[] bytes) throws IOException {
            try (ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(bytes);
                ...
                Map<OperatorIDPair, byte[]> operatorCoordinatorSnapshots =
                        InstantiationUtil.deserializeObject(
