...
public class TaskStateSnapshot implements CompositeStateHandle {
    ...
    private final Map<OPERATOR_ID_PAIR, OperatorSubtaskState> subtaskStatesByOperatorID;
    ...
    public TaskStateSnapshot(Map<OPERATOR_ID_PAIR, OperatorSubtaskState> subtaskStatesByOperatorID) {
        this(subtaskStatesByOperatorID, false, false);
    }

    private TaskStateSnapshot(
            Map<OPERATOR_ID_PAIR, OperatorSubtaskState> subtaskStatesByOperatorID,
    ...
    @Nullable
    public OperatorSubtaskState getSubtaskStateByOperatorID(OPERATOR_ID_PAIR operatorID) {
    ...
    public OperatorSubtaskState putSubtaskStateByOperatorID(
            @Nonnull OPERATOR_ID_PAIR operatorID, @Nonnull OperatorSubtaskState state) {
    ...
    public Set<Map.Entry<OPERATOR_ID_PAIR, OperatorSubtaskState>> getSubtaskStateMappings() {
