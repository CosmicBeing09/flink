...
public class PendingCheckpoint implements Checkpoint {
    ...
    private final Set<OPERATOR_ID_PAIR> notYetAcknowledgedOperatorCoordinators;
    ...
    public PendingCheckpoint(
            ...
            Collection<OPERATOR_ID_PAIR> operatorCoordinatorsToConfirm,
    ...
    public Map<OPERATOR_ID_PAIR, OperatorState> getOperatorStates() {
    ...
    public TaskAcknowledgeResult acknowledgeTask(
        ...
        synchronized (lock) {
            ...
            if (operatorSubtaskStates != null && operatorSubtaskStates.isTaskDeployedAsFinished()) {
                ...
                List<org.apache.flink.runtime.OperatorIDPair> operatorIDs = vertex.getJobVertex().getOperatorIDPairs();
    ...
    public TaskAcknowledgeResult acknowledgeCoordinatorState(
        ...
        synchronized (lock) {
            ...
            final OPERATOR_ID_PAIR operatorId = coordinatorInfo.operatorId();
