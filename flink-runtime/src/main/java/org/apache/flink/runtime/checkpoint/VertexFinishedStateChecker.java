...
public class VertexFinishedStateChecker {
    ...
    public VertexFinishedStateChecker(
            Set<ExecutionJobVertex> vertices, Map<OperatorIDPair, OperatorState> operatorStates) {
    ...
    private static class VerticesFinishedStatusCache {
        ...
        private VerticesFinishedStatusCache(Map<OperatorIDPair, OperatorState> operatorStates) {
            this.operatorStates = operatorStates;
        }
        ...
        private VertexFinishedState checkOperatorFinishedStatus(
                Map<OperatorIDPair, OperatorState> operatorStates, org.apache.flink.runtime.OperatorIDPair idPair) {
