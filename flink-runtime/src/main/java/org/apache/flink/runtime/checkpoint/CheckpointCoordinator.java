...
public class CheckpointCoordinator {
    ...
    private final BiFunction<
                    ...
                    Map<OperatorIDPair, OperatorState>,
    ...
    @GuardedBy("lock")
    private final Set<OperatorIDPair> backlogOperators = new HashSet<>();
     ...
     */
    public void setIsProcessingBacklog(OperatorIDPair operatorID, boolean isProcessingBacklog) {
        synchronized (lock) {
    ...
    private OptionalLong restoreLatestCheckpointedStateInternal(
        ...
        synchronized (lock) {
            ...
            final Map<OperatorIDPair, OperatorState> operatorStates = extractOperatorStates(latest);
    ...
    private Map<OperatorIDPair, OperatorState> extractOperatorStates(CompletedCheckpoint checkpoint) {
        Map<OperatorIDPair, OperatorState> originalOperatorStates = checkpoint.getOperatorStates();
        ...
        HashMap<OperatorIDPair, OperatorState> newStates = new HashMap<>();
    ...
    private void restoreStateToCoordinators(
            final long checkpointId, final Map<OperatorIDPair, OperatorState> operatorStates)
            throws Exception {
