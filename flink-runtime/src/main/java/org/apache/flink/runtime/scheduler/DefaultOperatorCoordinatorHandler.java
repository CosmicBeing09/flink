...
public class DefaultOperatorCoordinatorHandler implements OperatorCoordinatorHandler {
    ...
    private final Map<OPERATOR_ID_PAIR, OperatorCoordinatorHolder> coordinatorMap;
    ...
    private static Map<OPERATOR_ID_PAIR, OperatorCoordinatorHolder> createCoordinatorMap(
    ...
    @VisibleForTesting
    Map<OPERATOR_ID_PAIR, OperatorCoordinatorHolder> getCoordinatorMap() {
