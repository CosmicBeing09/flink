...
class ChannelStateHandleSerializer {
    ...
    public void serializeOutputStateHandle(OutputStateHandle handle, DataOutputStream dos) throws IOException {
    ...
    public void serializeInputStateHandle(InputStateHandle handle, DataOutputStream dos) throws IOException {
