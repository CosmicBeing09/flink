...
public class InputOutputFormatVertex extends JobVertex {
    ...
    private final Map<OPERATOR_ID_PAIR, String> formatDescriptions = new HashMap<>();
    ...
    public void initializeOnMaster(InitializeOnMasterContext context) throws Exception {
        ...
        try {
            ...
            for (Map.Entry<OPERATOR_ID_PAIR, UserCodeWrapper<? extends InputFormat<?, ?>>> entry :
            ...
            for (Map.Entry<OPERATOR_ID_PAIR, UserCodeWrapper<? extends OutputFormat<?>>> entry :
    ...
    public String getFormatDescription(OPERATOR_ID_PAIR operatorID) {
        return formatDescriptions.get(operatorID);
    }

    public void setFormatDescription(OPERATOR_ID_PAIR operatorID, String formatDescription) {
