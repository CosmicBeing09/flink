...
public final class OperatorEventDispatcherImpl implements OperatorEventDispatcher {
    ...
    private final Map<OperatorIDPair, OperatorEventHandler> handlers;
    ...
    void dispatchEventToHandlers(
            OperatorIDPair operatorID, SerializedValue<OperatorEvent> serializedEvent)
    ...
    @Override
    public void registerEventHandler(OperatorIDPair operator, OperatorEventHandler handler) {
    ...
    Set<OperatorIDPair> getRegisteredOperators() {
        return handlers.keySet();
    }

    @Override
    public OperatorEventGateway getOperatorEventGateway(OperatorIDPair operatorId) {
    ...
    private static final class OperatorEventGatewayImpl implements OperatorEventGateway {
        ...
        private OperatorEventGatewayImpl(
                TaskOperatorEventGateway toCoordinator, OperatorIDPair operatorId) {
